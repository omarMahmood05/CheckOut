...
export const getProductController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      error,
      message: "There was an error getting all the products",
    });
  }
};
...
export const productPhotoController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      error,
      message: "There was an error getting the images of the products",
    });
  }
};
...
export const deleteProductController = async (req, res) => {
  try {
    await productModels.findByIdAndDelete(req.params.pid).select("-photos");
    res.status(200).send({
      success: true,
